...
class BaseWindow{
public:
    //El procedimiento de ventana, debe ser estático ya que debe ser pasado como puntero a función.
    ...
    BaseWindow() : m_hwnd(NULL) {/*Acá el parámetro ya está inicilaizado*/}
